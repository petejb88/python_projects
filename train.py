...
parser = argparse.ArgumentParser(description="Train a flower classifier using a pre-trained model.")
parser.add_argument('data_dir', help="Location of data. Show have 'train' and 'valid' folders.")
